 ...
 *
 */
#ifndef emptyExample_hair_h
#define emptyExample_hair_h
#include "myLine.h"
...
public:
    ...
    void update(int theHair, myLine* theLines, float currentRadius) 
    {
        ...
        for(int i=0; i<16; i++)
        {
			...
			if(theHair == theLines[i].id && position.y > theLines[i].min_y && position.y < theLines[i].max_y)
			{
